      ...
      >
        ...
        >
          <div
            ...
            className="flex w-full h-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow-sm"
          >
            {children}
          </div>
        </div>
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "[[data-sidebar=group][data-collapsible=icon]_&]:opacity-0 group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
...
const sidebarMenuButtonVariants = (() => {
  ...
  return function getVariants(
    ...
    return cn(
      "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&>svg]:size-4 [&>svg]:shrink-0",
      variants[variant],
      sizes[size]
    )
  }
    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          "w-full",
          "group-data-[collapsible=icon]:!size-10 group-data-[collapsible=icon]:!p-0 group-data-[collapsible=icon]:[&>span:not([data-sidebar=icon])]:hidden group-data-[collapsible=icon]:[&>svg]:size-6",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "[[data-sidebar=menu-button]:focus-visible+&]:text-sidebar-accent-foreground",
        showOnHover &&
