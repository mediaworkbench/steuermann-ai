...
class TestHelpers:
    ...
    def test_resolve_local_image_valid(self, tmp_path):
    ...
    def test_resolve_local_image_path_traversal_rejected(self, tmp_path):
    ...
    def test_resolve_local_image_missing_file(self, tmp_path):
        with pytest.raises(FileNotFoundError):
            _resolve_local_image(str(tmp_path / "missing.jpg"), str(tmp_path))

    def test_resolve_local_image_unknown_extension_defaults_to_jpeg(self, tmp_path):
